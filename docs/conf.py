...
project = u'hera_stats'
copyright = u'%s, HERA Collaboration' % datetime.datetime.now().year
...
htmlhelp_basename = 'hera_statsdoc'
...
latex_documents = [
    (master_doc, 'hera_stats.tex', u'hera\\_stats Documentation',
...
man_pages = [
    (master_doc, 'hera_stats', u'hera_stats Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'hera_stats', u'hera_stats Documentation',
     author, 'hera_stats', 'HERA statistical analysis and null tests.',
     'Miscellaneous'),
]
